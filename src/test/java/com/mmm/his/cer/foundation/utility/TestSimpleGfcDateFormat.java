...
public class TestSimpleGfcDateFormat {
  ...
  public void testMMM_dd_yyyy_HH_mm_ss() {
    ...
    try {
      ...
      jdate = date.getDate();
      assertTrue("GfcDate (" + date.getTime() + ") and java Date  (" + jdate.getTime()
              + ") millis don't match. ",
   ...
   */
  public static void validateDateAfterOps(GfcDate date, int year, int month, int day,
      String strValue) {
    ...
    assertTrue("Bad string " + date, strValue.equals(date.toString()));
    ...
    assertTrue("After getDate(). Bad string " + date, strValue.equals(date.toString()));
    ...
    assertTrue("After toString(). Bad string " + date, strValue.equals(date.toString()));
    ...
    assertTrue("After getElapsedDays(). Bad string " + date, strValue.equals(date.toString()));
  }

  //
  //    System.out.println("GfcDate 1 - parsed using SimpleGfcDateFormat mmddyyyy, output w/
  //    GfcDate.toString(): " + gfcDate1.toString());
  //
  //    GfcDate gfcDate2 = new GfcDate(gfcDate1.getDate());
  //    System.out.println("GfcDate 2 - from GfcDate1 w/ constructor getDate(): " + gfcDate2
  //    .toString());
  //
  //    Date tmpDate = gfcDate1.getDate();
  //    GfcDate gfcDate3 = new GfcDate(tmpDate.getYear() + 1900, tmpDate.getMonth() + 1, tmpDate
  //    .getDate());
