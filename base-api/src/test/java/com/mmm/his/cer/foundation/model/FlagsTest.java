...
public class FlagsTest {
    ...
    public void flagsTest() {
        ...
        assertEquals("Flag GfcSex.FEMALE value should be in list", true, flags.isFlagValueSet(GfcSex.FEMALE));
        assertEquals("Flag for any GfcSex value should be in list", true, flags.isFlagSet(GfcSex.class));
